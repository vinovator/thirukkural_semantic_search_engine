...
# --- Page Config ---
st.set_page_config(page_title="Thirukural Semantic Search", page_icon="📜", layout="wide")
...
# --- Main UI ---
st.title("Thirukural Semantic Search Engine 📜")
st.markdown("Discover the timeless wisdom of Thirukural that resonates with any concept.")
